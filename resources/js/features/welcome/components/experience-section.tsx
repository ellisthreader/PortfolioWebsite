...
export function ExperienceSection({
    ...
    return (
        <section
            ref={sectionRef}
            className="relative min-h-[155vh] overflow-hidden bg-[#000000] text-white lg:min-h-[175vh]"
        >
            ...
            <div className="absolute left-1/2 top-[6%] hidden h-[72%] w-[44rem] -translate-x-1/2 bg-[radial-gradient(ellipse_at_center,_rgba(255,255,255,0.04)_0%,_rgba(255,186,239,0.05)_18%,_rgba(236,72,153,0.05)_30%,_rgba(217,70,239,0.03)_46%,_transparent_72%)] blur-3xl lg:block" />
            <div className="absolute left-1/2 top-[8%] hidden h-[68%] w-[62rem] -translate-x-1/2 bg-[radial-gradient(ellipse_at_center,_rgba(236,72,153,0.12)_0%,_rgba(217,70,239,0.08)_24%,_rgba(88,28,135,0.03)_45%,_transparent_72%)] blur-[110px] opacity-75 lg:block [animation:timeline-reflection-drift_9s_ease-in-out_infinite]" />
            <div className="pointer-events-none absolute inset-x-0 bottom-0 z-0 h-48 bg-[linear-gradient(180deg,rgba(0,0,0,0)_0%,rgba(0,0,0,0.72)_48%,#020104_100%)]" />

            <div className="relative mx-auto max-w-7xl px-6 pb-0 pt-24 sm:px-10 lg:px-16">
                <ExperienceHeader />
